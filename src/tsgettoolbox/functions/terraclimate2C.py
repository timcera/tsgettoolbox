...
_avail_vars = {
    ...
    "tmax": {
        ...
        "standard_name": "tmax",
        "units": "degC",
        "vname": "TerraClimate2C_tmax.nc",
    },
}


@mando.command("terraclimate2C", formatter_class=HelpFormatter, doctype="numpy")
...
def terraclimate2C(
    ...
    turl = "http://thredds.northwestknowledge.net:8080/thredds/ncss/grid/TERRACLIMATE_ALL/summaries/TerraClimate2C_{var}.nc/"
    ...
    if len(df.dropna(how="all")) == 0:
        ...
        raise ValueError(
            tsutils.error_wrapper(
                """
terraclimate2C returned no data for lat/lon "{lat}/{lon}", variables "{variables}"
