...
def ncei_normal_ann_cli(stationid, datatypeid=None):
    ...
    datatypeid : str
        ...
        |                         | xx is the base in degree F. 'xx' can be    |
        |                         | one of 40, 45, 50, 55, 57, 60, 65, 70, 72. |
        +-------------------------+--------------------------------------------+
        ...
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH040 | Average number of days per year where tmax |
        |                         | is greater than or equal to 40F            |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH050 | Average number of days per year where tmax |
        |                         | is greater than or equal to 50F            |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH060 | Average number of days per year where tmax |
        |                         | is greater than or equal to 60F            |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH070 | Average number of days per year where tmax |
        |                         | is greater than or equal to 70F            |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH080 | Average number of days per year where tmax |
        |                         | is greater than or equal to 80F            |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH090 | Average number of days per year where tmax |
        |                         | is greater than or equal to 90F            |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-GRTH100 | Average number of days per year where tmax |
        |                         | is greater than or equal to 100F           |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-AVGNDS-LSTH032 | Average number of days per year where tmax |
        |                         | is less than or equal to 32F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMAX-NORMAL         | Average annual maximum temperature         |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH000 | Average number of days per year where tmin |
        |                         | is less than or equal to 0F                |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH010 | Average number of days per year where tmin |
        |                         | is less than or equal to 10F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH020 | Average number of days per year where tmin |
        |                         | is less than or equal to 20F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH032 | Average number of days per year where tmin |
        |                         | is less than or equal to 32F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH040 | Average number of days per year where tmin |
        |                         | is less than or equal to 40F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH050 | Average number of days per year where tmin |
        |                         | is less than or equal to 50F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH060 | Average number of days per year where tmin |
        |                         | is less than or equal to 60F               |
        +-------------------------+--------------------------------------------+
        | ANN-TMIN-AVGNDS-LSTH070 | Average number of days per year where tmin |
        ...
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE40         | Average fall growing degree days with base |
        |                         | 40F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE45         | Average fall growing degree days with base |
        |                         | 45F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE50         | Average fall growing degree days with base |
        |                         | 50F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE55         | Average fall growing degree days with base |
        |                         | 55F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE57         | Average fall growing degree days with base |
        |                         | 57F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE60         | Average fall growing degree days with base |
        |                         | 60F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE65         | Average fall growing degree days with base |
        |                         | 65F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE70         | Average fall growing degree days with base |
        |                         | 70F                                        |
        +-------------------------+--------------------------------------------+
        | SON-GRDD-BASE72         | Average fall growing degree days with base |
        |                         | 72F                                        |
        +-------------------------+--------------------------------------------+
        ...
        |                         | tmin is less than or equal to 'xxx' degree |
        |                         | F. Where 'xxx' is one of 000, 010, 020,    |
        |                         | 032, 040, 050, 060, 070                    |
        +-------------------------+--------------------------------------------+
...
def ncei_normal_dly_cli(stationid, datatypeid=None):
    ...
    datatypeid
        ...
        |                         | for 29-day windows centered on each day of |
        |                         | the year                                   |
        +-------------------------+--------------------------------------------+
        ...
        |                         | totals for 29-day windows centered on each |
        |                         | day of the year                            |
        +-------------------------+--------------------------------------------+
...
def ncei_normal_mly_cli(stationid, datatypeid=None):
    ...
    datatypeid : str
        ...
        | Code                    | Description                                |
        +=========================+============================================+
        | MLY-CLDD-BASE45         | Average monthly cooling degree days with   |
        |                         | base 45F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-BASE50         | Average monthly cooling degree days with   |
        |                         | base 50F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-BASE55         | Average monthly cooling degree days with   |
        |                         | base 55F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-BASE57         | Average monthly cooling degree days with   |
        |                         | base 57F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-BASE60         | Average monthly cooling degree days with   |
        |                         | base 60F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-BASE70         | Average monthly cooling degree days with   |
        |                         | base 70F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-BASE72         | Average monthly cooling degree days with   |
        |                         | base 72F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-CLDD-NORMAL         | Average monthly cooling degree days with   |
        |                         | base 65F                                   |
        +-------------------------+--------------------------------------------+
        ...
        |                         | diurnal temperature range                  |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE40         | Average monthly growing degree days with   |
        |                         | base 40F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE45         | Average monthly growing degree days with   |
        |                         | base 45F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE50         | Average monthly growing degree days with   |
        |                         | base 50F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE55         | Average monthly growing degree days with   |
        |                         | base 55F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE57         | Average monthly growing degree days with   |
        |                         | base 57F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE60         | Average monthly growing degree days with   |
        |                         | base 60F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE65         | Average monthly growing degree days with   |
        |                         | base 65F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE70         | Average monthly growing degree days with   |
        |                         | base 70F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-GRDD-BASE72         | Average monthly growing degree days with   |
        |                         | base 72F                                   |
        +-------------------------+--------------------------------------------+
        ...
        |                         | truncated bases 50F and 86F                |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-BASE40         | Average monthly heating degree days with   |
        |                         | base 40F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-BASE45         | Average monthly heating degree days with   |
        |                         | base 45F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-BASE50         | Average monthly heating degree days with   |
        |                         | base 50F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-BASE55         | Average monthly heating degree days with   |
        |                         | base 55F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-BASE57         | Average monthly heating degree days with   |
        |                         | base 57F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-BASE60         | Average monthly heating degree days with   |
        |                         | base 60F                                   |
        +-------------------------+--------------------------------------------+
        | MLY-HTDD-NORMAL         | Average monthly heating degree days with   |
        |                         | base 65F                                   |
        +-------------------------+--------------------------------------------+
        ...
        |                         | totals                                     |
        +-------------------------+--------------------------------------------+
        | MLY-SNOW-AVGNDS-GE001TI | Average number of days per month with      |
        |                         | Snowfall >= 0.1 in                         |
        +-------------------------+--------------------------------------------+
        | MLY-SNOW-AVGNDS-GE010TI | Average number of days per month with      |
        |                         | Snowfall >= 1.0 in                         |
        +-------------------------+--------------------------------------------+
        | MLY-SNOW-AVGNDS-GE030TI | Average number of days per month with      |
        |                         | Snowfall >= 3.0 in                         |
        +-------------------------+--------------------------------------------+
        | MLY-SNOW-AVGNDS-GE050TI | Average number of days per month with      |
        |                         | Snowfall >= 5.0 in                         |
        +-------------------------+--------------------------------------------+
        | MLY-SNOW-AVGNDS-GE100TI | Average number of days per month with      |
        |                         | Snowfall >= 10.0 in                        |
        +-------------------------+--------------------------------------------+
        ...
        |                         | average temperature                        |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH040 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 40F       |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH050 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 50F       |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH060 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 60F       |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH070 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 70F       |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH080 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 80F       |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH090 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 90F       |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-GRTH100 | Average number of days per month where     |
        |                         | tmax is greater than or equal to 100F      |
        +-------------------------+--------------------------------------------+
        | MLY-TMAX-AVGNDS-LSTH032 | Average number of days per month where     |
        |                         | tmax is less than or equal to 32F          |
        +-------------------------+--------------------------------------------+
        ...
        |                         | maximum temperature                        |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH000 | Average number of days per month where     |
        |                         | tmin is less than or equal to 0F           |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH010 | Average number of days per month where     |
        |                         | tmin is less than or equal to 10F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH020 | Average number of days per month where     |
        |                         | tmin is less than or equal to 20F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH032 | Average number of days per month where     |
        |                         | tmin is less than or equal to 32F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH040 | Average number of days per month where     |
        |                         | tmin is less than or equal to 40F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH050 | Average number of days per month where     |
        |                         | tmin is less than or equal to 50F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH060 | Average number of days per month where     |
        |                         | tmin is less than or equal to 60F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-AVGNDS-LSTH070 | Average number of days per month where     |
        |                         | tmin is less than or equal to 70F          |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-NORMAL         | Average monthly minimum temperature        |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-PRBOCC-LSTH016 | probability of 16F or below at least once  |
        |                         | in the month                               |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-PRBOCC-LSTH020 | probability of 20F or below at least once  |
        |                         | in the month                               |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-PRBOCC-LSTH024 | probability of 24F or below at least once  |
        |                         | in the month                               |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-PRBOCC-LSTH028 | probability of 28F or below at least once  |
        |                         | in the month                               |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-PRBOCC-LSTH032 | probability of 32F or below at least once  |
        |                         | in the month                               |
        +-------------------------+--------------------------------------------+
        | MLY-TMIN-PRBOCC-LSTH036 | probability of 36F or below at least once  |
        |                         | in the month                               |
        +-------------------------+--------------------------------------------+
...
ncei_ish.__doc__ = ncei_ish_cli.__doc__
